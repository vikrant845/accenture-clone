...
const JobsSection = ({ children, background, title, description, explore=false, recents=true, recentData={}, jobs={}, actions=false }) => {
  ...
  return (
    <div className={ `py-10 font-bold ${ background ? 'bg-[#F2F2F2]' : 'bg-white' }` }>
      <div className="lg:w-[75rem] lg:px-0 w-full px-16 mx-auto">
        <div className='flex justify-between items-center'>
          <h1 className="text-5xl">{ title }</h1>
          { explore && <a href="#" className="text-lg text-blue-700">EXPLORE MORE JOBS</a> }
        </div>
